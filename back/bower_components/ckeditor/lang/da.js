...
const danishTranslations = {
  ...
  uploadwidget: {
    abort: "Upload er afbrudt af brugeren.",
  ...
  pastetext: {
    ...
    pasteNotification:
      "Tryk %1 for at indsætte. Din browser understøtter ikke indsættelse med værktøjslinieknappen eller kontekstmenuen.",
  ...
  filetools: {
    ...
    httpError404: "Der skete en HTTP fejl under uploadingen (404: Filen blev ikke fundet).",
    httpError403: "Der skete en HTTP fejl under uploadingen (403: Forbudt).",
    httpError: "Der skete en HTTP fejl under uploadingen (fejlstatus: %1).",
    noUrlError: "Upload-URL er ikke defineret.",
    responseError: "Ikke korrekt svar fra serveren.",
  },
  fakeobjects: {
    anchor: "Anker",
  ...
  clipboard: {
    ...
    paste: "Indsæt",
    pasteNotification:
      "Tryk %1 for at sætte ind. Din browser understøtter ikke indsættelse med værktøjslinieknappen eller kontekstmenuen.",
    pasteArea: "Indsættelsesområde",
  ...
  about: {
    ...
    moreInfo: "Se vores hjemmeside for informationer om licenser:",
  },
  ...
  common: {
    ...
    cssLengthTooltip:
      'Indsæt et numerisk værdi i pixel eller et nummer med en gyldig CSS værdi (px, %, in, cm, mm, em, ex, pt, eller pc).',
