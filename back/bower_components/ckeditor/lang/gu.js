...
const gu = {
  ...
  table: {
    ...
    cell: {
      menu: 'કોષના ખાના',
      insertBefore: 'પહેલાં કોષ ઉમેરવી',
      insertAfter: 'પછી કોષ ઉમેરવી',
      deleteCell: 'કોષ ડિલીટ/કાઢી નાખવી',
      merge: 'કોષ ભેગા કરવા',
  ...
  specialchar: {
    ...
    title: 'સ્પેશિઅલ વિશષ્ટ અક્ષર પસંદ કરો',
    toolbar: 'વિશષ્ટ અક્ષર ઇન્સર્ટ/દાખલ કરવું'
  },
  sourcearea: {
