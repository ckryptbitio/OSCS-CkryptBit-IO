...
var SF = (function () {
  ...
  var b = {
    ...
    accept: function (a, e) {
      ...
      for (var d = c ? c.length || 0 : 0; d--;)
        this.accept(c[d], e);
    },
    getByClass: function () {
      var a = document.getElementsByClassName;
      return "function" === typeof a ? function (e, b) {
        "string" === typeof e && (b = e, e = document.getElementsByTagName("html")[0]);
        var c = [];
        this.accept(e, function (e) {
          this.classList.contains(e, b) && c.push(e)
        });
        return c
      } : function (a, c) {
        "string" === typeof a && (c = a, a = document.getElementsByTagName("html")[0]);
        var d = [];
        this.accept(a, function (a) {
    ...
    classList: {},
    classListAdd: function (a, b) {
      var f = d(a);
      f.push(b);
      a.attributes.setNamedItem(c(f));
    },
    classListRemove: function (a, e) {
      var f = d(a, e),
        n = this.indexOf(f, e);
      -1 !== n && (f.splice(n, 1), a.attributes.setNamedItem(c(f)));
    },
    classListContains: function (a, c) {
      return -1 !== this.indexOf(d(a), c);
    },
    classListToggle: function (a, b) {
...
(function () {
  for (
    var d = SF.getByClass("toggler"), c = d.length;
    c--;
...
(function () {
  for (
    var d = SF.getByClass("tree-a"), c = d.length;
    c--;
...
(function (d, c) {
  ...
  function a() {
    ...
    return {
      ...
      trigger: function (b) {
        for (
          var c = !0, d = { preventDefault: function () { c = !1 } }, e = 0;
          e < a.length;
          e++
        )
          a[e](b, d);
  ...
  function f(a, b) {
    return new e(c.createElement("div")).clazz(a("overlayClass", "")).stylize({
      display: "block",
      position: "fixed",
      top: "0px",
      left: "0px",
      ...
      width: "100%",
      zIndex: 1e4,
    }).stylize(a("overlayStyles", { opacity: .5, background: "#000" })).onClick(
      function () {
        a("overlayClose", !0) && b();
      }
    );
  ...
  function n(a, b) {
    ...
    return new e(c.createElement("div")).clazz(a("modalClass", "")).stylize({
      display: "block",
      position: "fixed",
      zIndex: 10001,
      left: "50%",
  ...
  e.prototype = {
    ...
    stylize: function (a) {
      a = a || {};
      "undefined" !== typeof a.opacity && (a.filter = "alpha(opacity=" + 100 * a.opacity + ")");
      for (var b in a)
